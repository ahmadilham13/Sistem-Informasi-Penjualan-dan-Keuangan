      ...
      <div class="flex items-center">
        ...
        <div x-data="{ linkActive: false }" class="relative mx-6">
          ...
          <div @click="linkActive = !linkActive" class="flex cursor-pointer">
            <svg class="w-6 h-6 cursor-pointer hover:text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path>
            </svg>
            <sub>
              <span class="bg-indigo-600 text-gray-100 px-1.5 py-0.5 rounded-full -ml-1 animate-pulse">
                4
              </span>
            </sub>
          </div>
          ...
          <!-- start::Submenu -->
          <div x-show="linkActive" @click.away="linkActive = false" x-cloak class="absolute right-0 z-10 border border-gray-300 w-96 top-11">
            ...
            <div class="overflow-y-scroll bg-white rounded max-h-96 custom-scrollbar">
              ...
              <!-- end::Submenu header -->
              <!-- start::Submenu link -->
              <a x-data="{ linkHover: false }" href="#" class="flex items-center justify-between px-3 py-4 hover:bg-gray-100 bg-opacity-20" @mouseover="linkHover = true" @mouseleave="linkHover = false">
                <div class="flex items-center">
                  <svg class="w-8 h-8 bg-primary bg-opacity-20 text-primary px-1.5 py-0.5 rounded-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a x-data="{ linkHover: false }" href="#" class="flex items-center justify-between px-3 py-4 hover:bg-gray-100 bg-opacity-20" @mouseover="linkHover = true" @mouseleave="linkHover = false">
                <div class="flex items-center">
                  <img src="{{ Vite::asset('resources/images/user/01.jpg') }}" class="w-8 rounded-full" />
                  <div class="ml-3 text-sm">
                    <p class="font-bold text-gray-600 capitalize" :class=" linkHover ? 'text-primary' : ''">
