                            ...
                            <x-table-row>
                                ...
                                <x-table-actions>
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="#" class="px-4 py-2 text-xs font-medium text-indigo-500 transition duration-150 rounded bg-indigo-50 hover:bg-indigo-500 hover:text-white">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18">
                                                <path
                    ...
                    <div class="relative w-full h-full max-w-md p-4 md:h-auto" @click.away="openDelete = false; petugasId: 0">
                        ...
                        <div class="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
                            ...
                            <div class="flex items-center justify-center space-x-4">
                                {{-- <form :action="route('group-user.destroy', {'group_user': groupUserId}, false)" method="POST">
                                    @csrf
                                    @method('DELETE') --}}
                                ...
                                {{-- </form> --}}
                                <button @click="openDelete = false; groupUserId: 0"
